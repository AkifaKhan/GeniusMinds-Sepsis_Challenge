...
def get_selected_features(data):
    features= [
        "agecalc_adm", "height_cm_adm", "bcsverbal_adm", "hr_bpm_adm", "lengthadm", "glucose_mmolpl_adm", 
        "rr_brpm_app_adm", "diasbp_mmhg_adm", "hematocrit_gpdl_adm", "weight_kg_adm", "muac_mm_adm", 
        "exclbreastfed_adm", "bcseye_adm", "sysbp_mmhg_adm", "temp_c_adm", "lactate_mmolpl_adm", 
        "spo2site2_pc_oxi_adm", "sqi2_perc_oxi_adm", "momage_adm", "householdsize_adm", "momagefirstpreg_adm", 
        "sqi1_perc_oxi_adm", "bcsmotor_adm", "spo2site1_pc_oxi_adm", "spo2onoxy_adm", "feedingstatus_adm", 
        "alivechildren_adm", "totalbreastfed_adm", "oxygenavail_adm", "watersource_adm", "deadchildren_adm", 
        "vaccdpt_adm", "lightfuel_adm", "deliveryloc_adm", "bednet_adm", "diarrheaoften_adm", "vaccpneumoc_adm", 
         "priorweekantimal_adm", "priorweekabx_adm", "bcgscar_adm",
        "malariastatuspos_adm", "waterpure_adm"
    ] 
...
def train_challenge_model(data_folder, model_folder, verbose):
    ...
    data=get_selected_features(data)
